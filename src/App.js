...
import {Button, Card} from 'substance-ui';
  ...
  render() {
    return (
      <div>
        ...
        <div style={{background: '#F9F9F9',  paddingTop: '100px', paddingBottom: '100px'}}>
        ...
        <Grid fluid>
          <h2>Cards</h2>
          <Row>
            <Col xs={12} sm={6} md={4}><Card><h3>Normal Card</h3></Card></Col>
            <Col xs={12} sm={6} md={4}><Card static><h3>Static Card</h3></Card></Col>
            <Col xs={12} sm={6} md={4}><Card square><h3>Square Card</h3></Card></Col>
          </Row>
        </Grid>
